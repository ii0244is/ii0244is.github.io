...
glObject2DImage = function ( glCanvas )
{
...
glObject2DImage.prototype.release = function (glContext)
{
    let gl = glContext;
...
glObject2DImage.prototype.attachShader = function ( shader )
{
    this.shader = this.webGLView.webGLShaderList[shader];
}

glObject2DImage.prototype.setVisible = function ( visible )
{
    this.visible = visible;
}

glObject2DImage.prototype.setWorldMat = function ( worldMat )
{
    this.WorldMatrix = worldMat;
}

glObject2DImage.prototype.setScaleMat = function ( scaleMat )
{
    this.ScaleMatrix = scaleMat;
}

glObject2DImage.prototype.setView = function ( viewMat )
{
    this.ViewMatrix = viewMat;
}

glObject2DImage.prototype.setProjection = function ( projMatrix )
{
    this.ProjMatrix = projMatrix;
}

glObject2DImage.prototype.setColor = function (r, g, b, a)
{
    this.colorR = r;
    this.colorG = g;
    this.colorB = b;
...
glObject2DImage.prototype.setObjectID = function ( id )
{
...
glObject2DImage.prototype.setImage = function (glContext, url, callback)
{
	let gl = glContext;
...
glObject2DImage.prototype.setPosition = function ( x, y, width, height )
{
    this.position[0] = x;
    this.position[1] = y;
    this.size[0] = width;
...
glObject2DImage.prototype.drawObjectIDMap = function ( glContext )
{   
}

glObject2DImage.prototype.draw = function ( glContext, time )
{
