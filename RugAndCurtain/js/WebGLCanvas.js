...
WebGLCanvas = function ()
{
    ...
    this.canvas.addEventListener("mousedown", function (event) {
        ...
        this.hitPos = this.calcHitPoint( x, y );
...
WebGLCanvas.prototype.calcRayVector = function( screenX, screenY )
{
    ...
    let posX = this.cameraPosX;
    let posY = this.cameraPosY;
    let posZ = this.cameraPosZ;
...
WebGLCanvas.prototype.calcHitPoint = function( screenX, screenY )
{    
    // ray
    let ray = this.calcRayVector( screenX, screenY );
