...
glObjectPlane.prototype.setRotation = function ( rotation )
{
...
glObjectPlane.prototype.setImage = function (glContext, url, callback)
{
	let gl = glContext;
...
glObjectPlane.prototype.setTexture = function (name)
{
    this.textureName = name;
    this.isImageSet = true;
}

glObjectPlane.prototype.rotateTexture = function ()
{
    ++this.textureRotate;
    if( this.textureRotate > 3 ){
        this.textureRotate = 0;
    }
}

glObjectPlane.prototype.setBillboardMode = function( enable )
{
...
glObjectPlane.prototype.drawObjectIDMap = function ( glContext )
{
    ...
    mat4.rotate(tempMat, this.rotation[0] * 3.141592 / 180, [1, 0, 0], rotMat);
    mat4.rotate(rotMat, this.rotation[1] * 3.141592 / 180, [0, 1, 0], rotMat);
    mat4.rotate(rotMat, this.rotation[2] * 3.141592 / 180, [0, 0, 1], rotMat);
    mat4.translate(tempMat, this.position, transMat);
    mat4.multiply(transMat, scaleMat, this.WorldMatrix);
    mat4.multiply(this.WorldMatrix, rotMat, this.WorldMatrix);
...
glObjectPlane.prototype.draw = function ( glContext, time )
{
    ...
    let param = [ time / 100, isBlinking, this.textureRotate, 0.0 ];
